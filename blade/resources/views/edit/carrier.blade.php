...
@section('title', 'Редактирование профиля перевозчика')
 
@section('content')

<!-- *************************** ПЕРВЫЙ ЭКРАН ***************************************- -->
        <div class="first-screen-page-bg bg-page reg-carrier-bg">
            <div class="first-screen-page">
                <div class="first-screen-page__title">
                    <h1>Редактирование профиля ПЕРЕВОЗЧИКА</h1>
                </div>              
            </div>      
        </div>
        ...
        <div class="page-block-bg top-shadow">
            ...
            <div class="page-block form-reg-carrier-wrapper">
                <div class="scan__wrapper">
                    <form method="POST" action="{{ route('updatecarrier', $user->id) }}">
                     {{ csrf_field() }}
                        ...
                        <div class="scan__block-row">
                            ...
                            <div class="row-col">
                                <div class="scan__block-col col-1-2">
                                    <div class="wrapper m-bottom">
                                        ...
                                        <div class="input input--small input--max">
                                            <input type="text" class="user-input" id="user-1-carrier" name="user-1-carrier" value="@if (null !== $user){{$user->name}}@endif" required>
                                        </div> 
                                ...
                                <div class="scan__block-col col-1-2">
                                    <div class="wrapper m-bottom">
                                        ...
                                        <div class="input input--small input--max">
                                            <input type="text" class="user-input" id="user-2-carrier" name="user-2-carrier" value="@if (null !== $user){{$user->lastname}}@endif" required>            
                                        </div>
                                        <script type="text/javascript">
                                            jQuery(function($){
                            ...
                            <div class="row-col">
                                <div class="wrapper m-bottom">
                                    ...
                                    <div class="input input--small input--max">
                                        <input type="text" class="user-input" id="user-3-carrier" name="user-3-carrier" value="@if (null !== $user){{$user->city}}@endif" required>            
                                    </div>
                                    <script type="text/javascript">
                                        jQuery(function($){
                                ...
                                <div class="wrapper m-bottom">
                                    ...
                                    <div class="input input--small input--max">
                                        <input type="text" class="user-input" id="user-4-carrier" name="user-4-carrier" value="@if (null !== $user){{$user->company}}@endif" required>            
                                    </div>
                                    <script type="text/javascript">
                                        jQuery(function($){
                                ...
                                <div class="wrapper m-bottom">
                                    ...
                                    <div class="input input--small input--large">
                                        <input type="text" class="user-input" id="user-5-carrier" name="user-5-carrier" value="@if (null !== $user){{$user->phone}}@endif" required>            
                                    </div>
                                    <script type="text/javascript">
                                        jQuery(function($){
                            ...
                            <div class="row-col">
                                <div class="wrapper m-bottom">
                                    ...
                                    <div class="ch_wrapper in-block">
                                        ...
                                        <label for="check9">Водитель</label>
                                    </div>
                                    <div class="ch_wrapper in-block">
                                        <input id="check10" type="checkbox" name="check" value="check10">
                                        <label for="check10">Собственник</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row-col">
                                <div class="wrapper m-bottom">
                                    ...
                                    <div class="ch_wrapper in-block">
                                        <input id="check-entity" onchange="ShowStepContact(this)" type="checkbox" name="check-entity" value="1" @if (null !== $user->entity) checked @endif>
                                        <label for="check-entity">Есть Юридическое лицо</label>
                                    </div>
                                    <script type="text/javascript">
                                        function ShowStepContact(elem) {
                                            if (elem.checked) document.querySelector('.step-contact').style.display = 'block'
                                            else document.querySelector('.step-contact').style.display = 'none';
                                        }
                                    </script>
...
<!-- *************************** ШАГ 2 ***************************************- -->
                        <div class="scan__block-row step-contact" style="@if (null !== $user->entity) display: block; @endif">
