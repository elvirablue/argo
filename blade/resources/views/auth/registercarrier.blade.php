...
@section('title', 'Регистрация перевозчика')
        ...
        <div class="page-block-bg top-shadow">
            ...
            <div class="breadcrumbs">
                <ul>
                    ...
                    <li class="active"><a >Регистрация ПЕРЕВОЗЧИКА</a></li>
                </ul>
            ...
            <div class="page-block form-reg-carrier-wrapper">
                <div class="scan__wrapper">
                    <form method="POST" action="{{ route('createcarrier') }}">
                     {{ csrf_field() }}
...
<!-- *************************** ШАГ 2 ***************************************- -->
                        <div class="scan__block-row step-contact">
